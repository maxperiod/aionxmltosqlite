...
(
select distinct name, desc, hpgauge_level, magical_skill_boost, magical_skill_boost_resist
from 
...
str as 
(
select name, body from enu_data_strings_client_strings_monster str
union all
select name, body from enu_data_strings_client_strings_npc str
)
