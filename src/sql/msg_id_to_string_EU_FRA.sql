...
DROP TABLE IF EXISTS _MSG_CODE_TO_STRING_EU_FRA;

CREATE TABLE _MSG_CODE_TO_STRING_EU_FRA AS 
...
UNION ALL*/
SELECT id, name, body FROM FRA_Data_Strings_client_strings_msg
...
*/
UNION ALL
SELECT id, name, body FROM FRA_Data_Strings_client_strings_ui
WHERE 
