...
select distinct desc, hpgauge_level, magical_skill_boost, magical_skill_boost_resist
from 
client_npcs_abyss_monster tbl
union all
select distinct desc, hpgauge_level, magical_skill_boost, magical_skill_boost_resist
from 
client_npcs_std_monster tbl
union all
select distinct desc, hpgauge_level, magical_skill_boost, magical_skill_boost_resist
from 
client_npcs_test_monster tbl
),
str as 
(
select name, body from client_strings_monster str
union all
select name, body from client_strings_npc str
)
