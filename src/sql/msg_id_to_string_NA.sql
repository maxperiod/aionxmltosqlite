...
DROP TABLE IF EXISTS _MSG_CODE_TO_STRING_NA;

CREATE TABLE _MSG_CODE_TO_STRING_NA AS 
...
UNION ALL*/
SELECT id, name, body FROM ENU_Data_Strings_client_strings_msg
...
*/
UNION ALL
SELECT id, name, body FROM ENU_Data_Strings_client_strings_ui
WHERE 
